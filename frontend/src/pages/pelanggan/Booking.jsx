...
export default function Booking() {
  ...
  const id_paket = new URLSearchParams(search).get("id_paket");
  ...
  const handleBooking = async () => {
    ...
    const res = await fetch("http://localhost:7000/transaksi/tambah", {
      method: "POST",
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.left}>
        <img
          src={`http://localhost:7000/uploads/${paket?.gambar}`}
      ...
      <div style={styles.right}>
        ...
        <input type="text" value={pelanggan.nama} disabled style={styles.input} />

        <label style={styles.label}>Email</label>
        <input type="text" value={pelanggan.email} disabled style={styles.input} />

        <label style={styles.label}>No HP</label>
        <input type="text" value={pelanggan.no_hp} disabled style={styles.input} />

        <label style={styles.label}>Paket</label>
        <input type="text" value={paket?.nama_paket} disabled style={styles.input} />
